        ...
        children: <Widget>[
          ...
          StaggeredGridTile.count(
            ...
            child: buildTile(
                ...
                mode: 'ASSIGN_TO',
                image:
                    Image(image: AssetImage('assets/images/task-pending.png')),
                ntsType: NTSType.task),
          ),
          StaggeredGridTile.count(
            crossAxisCellCount: 1,
            ...
            child: buildTile(
                ...
                mode: 'ASSIGN_TO',
                image: Image(
                    image: AssetImage('assets/images/task-completed.png')),
          ...
          StaggeredGridTile.count(
            ...
            child: buildTile(
                ...
                image:
                    Image(image: AssetImage('assets/images/task-overdue.png')),
        ...
        children: <Widget>[
          ...
          StaggeredGridTile.count(
            ...
            child: buildTile(
                ...
                mode: 'REQ_BY',
                image: Image(
                    image: AssetImage('assets/images/service-overdue.png')),
          ...
          StaggeredGridTile.count(
            ...
            child: buildTile(
                ...
                mode: 'REQ_BY',
                image: Image(
                    image: AssetImage('assets/images/service-pending.png')),
                ntsType: NTSType.service),
          ),
          StaggeredGridTile.count(
            crossAxisCellCount: 1,
            ...
            child: buildTile(
                ...
                mode: 'REQ_BY',
                image: Image(
                    image: AssetImage('assets/images/service-completed.png')),
                ntsType: NTSType.service),
          ),
          StaggeredGridTile.count(
            crossAxisCellCount: 1,
            ...
            child: buildTile(
                ...
                mode: 'REQ_BY',
                image:
                    Image(image: AssetImage('assets/images/service-draft.png')),
                ntsType: NTSType.service),
          ),
          StaggeredGridTile.count(
            crossAxisCellCount: 3,
