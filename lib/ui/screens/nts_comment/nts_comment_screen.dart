...
class NTSCommentScreen extends StatefulWidget {
  NTSCommentScreen({Key key, this.ntsType, this.ntsId}) : super(key: key);
  final NTSType ntsType;
  final String ntsId;
  @override
  _NTSCommentScreenState createState() => _NTSCommentScreenState();
}

class _NTSCommentScreenState extends State<NTSCommentScreen> {
  @override
