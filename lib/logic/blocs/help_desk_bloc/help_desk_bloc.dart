...
import 'package:hr_management/data/repositories/help_desk_respository/abstract_help_desk_repo.dart';
...
class HelpDeskBloc {
  ...
  getHelpdeskDashboardData({
    ...
    HelpDeskDashboardResponse response = await _helpDeskRepository
        .getHelpdeskDashboardData(queryparams: queryparams);
  ...
  getHelpDeskRequestClosedData({
    ...
    ReadHelpDeskRequestClosedResponse response = await _helpDeskRepository
        .getHelpDeskRequestClosedData(queryparams: queryparams);
