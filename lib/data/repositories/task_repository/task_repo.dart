...
class TaskRepository extends AbstractTaskRepository {
  ...
  Future<TaskSummaryResponse> getTaskSummaryData({
    ...
    final String endpoint = APIEndpointConstants.GET_TASK_SUMMARY;
    ...
    try {
      ...
      return TaskSummaryResponse.withError("$err");
    }
  }
  ...
  Future<TaskListResponseModel> getReadTaskList({
    Map<String, dynamic>? queryparams,
  }) async {
    final String endpoint = APIEndpointConstants.GET_READ_TASK_LIST;
