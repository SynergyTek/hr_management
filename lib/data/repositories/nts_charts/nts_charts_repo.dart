...
class NTSChartRepository extends AbstractNTSChartRepository {
  ...
  @override
  Future<ChartResponse> getChartByUserType({Map<String, dynamic> queryparams, NTSType ntsType}) {
    throw UnimplementedError();
  }

  @override
  Future<ChartResponse> getDatewiseSLA({Map<String, dynamic> queryparams, NTSType ntsType}) {
    throw UnimplementedError();
  }
