class TaskListModel {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['IsTaskTeamOwner'] = this.isTaskTeamOwner;
    ...
    data['TaskStatusCode'] = this.taskStatusCode;
    ...
    data['TaskActionId'] = this.taskActionId;
    data['TaskAction'] = this.taskAction;
    ...
    data['TaskTemplate'] = this.taskTemplate;
    ...
    data['TaskOwnerTypeId'] = this.taskOwnerTypeId;
    data['TaskOwnerType'] = this.taskOwnerType;
    data['AssignedToTypeId'] = this.assignedToTypeId;
    data['AssignedToType'] = this.assignedToType;
    data['AssignedToUserId'] = this.assignedToUserId;
    data['AssignedToUser'] = this.assignedToUser;
    data['AssignedToTeamId'] = this.assignedToTeamId;
    data['AssignedToTeam'] = this.assignedToTeam;
    ...
    data['AssignedToHierarchyMasterId'] = this.assignedToHierarchyMasterId;
    data['AssignedToHierarchyMasterLevelId'] =
        this.assignedToHierarchyMasterLevelId;
    data['IsVersioning'] = this.isVersioning;
    data['StepTaskComponentId'] = this.stepTaskComponentId;
    data['Id'] = this.id;
