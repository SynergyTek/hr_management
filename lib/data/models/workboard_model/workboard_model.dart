...
//
//     final workboardModel = workboardModelFromJson(jsonString);

import 'dart:convert';

List<WorkboardModel> workboardModelFromJson(String str) => List<WorkboardModel>.from(json.decode(str).map((x) => WorkboardModel.fromJson(x)));

String workboardModelToJson(List<WorkboardModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class WorkboardModel {
    ...
    factory WorkboardModel.fromJson(Map<String, dynamic> json) => WorkboardModel(
        ...
        templateTypeName: json["TemplateTypeName"] == null ? null : templateTypeNameValues.map?[json["TemplateTypeName"]],
        ...
        noteStatusBgCss: json["NoteStatusBgCss"] == null ? null : noteStatusBgCssValues.map?[json["NoteStatusBgCss"]],
        noteStatusFontCss: json["NoteStatusFontCss"] == null ? null : noteStatusFontCssValues.map?[json["NoteStatusFontCss"]],
        ...
        activeUserType: json["ActiveUserType"] == null ? null : json["ActiveUserType"],
        sharedByUserId: json["SharedByUserId"],
        sharedWithUserId: json["SharedWithUserId"],
        sharedListText: json["SharedListText"] == null ? null : json["SharedListText"],
        ...
        includeReadonlyData: json["IncludeReadonlyData"] == null ? null : json["IncludeReadonlyData"],
        isDraftButtonVisible: json["IsDraftButtonVisible"] == null ? null : json["IsDraftButtonVisible"],
        isAcceptButtonVisible: json["IsAcceptButtonVisible"] == null ? null : json["IsAcceptButtonVisible"],
        isSubmitButtonVisible: json["IsSubmitButtonVisible"] == null ? null : json["IsSubmitButtonVisible"],
        isExpireButtonVisible: json["IsExpireButtonVisible"] == null ? null : json["IsExpireButtonVisible"],
        isInEditMode: json["IsInEditMode"] == null ? null : json["IsInEditMode"],
        isVersioningButtonVisible: json["IsVersioningButtonVisible"] == null ? null : json["IsVersioningButtonVisible"],
        isReplyButtonVisible: json["IsReplyButtonVisible"] == null ? null : json["IsReplyButtonVisible"],
        isBackButtonVisibile: json["IsBackButtonVisibile"] == null ? null : json["IsBackButtonVisibile"],
        isPermittedUser: json["IsPermittedUser"] == null ? null : json["IsPermittedUser"],
        isAddCommentEnabled: json["IsAddCommentEnabled"] == null ? null : json["IsAddCommentEnabled"],
        isAddAttachmentEnabled: json["IsAddAttachmentEnabled"] == null ? null : json["IsAddAttachmentEnabled"],
        isSharingEnabled: json["IsSharingEnabled"] == null ? null : json["IsSharingEnabled"],
        isCompleteButtonVisible: json["IsCompleteButtonVisible"] == null ? null : json["IsCompleteButtonVisible"],
        isCloseButtonVisible: json["IsCloseButtonVisible"] == null ? null : json["IsCloseButtonVisible"],
        sharedCount: json["SharedCount"] == null ? null : json["SharedCount"],
        attachmentCount: json["AttachmentCount"] == null ? null : json["AttachmentCount"],
        notificationCount: json["NotificationCount"] == null ? null : json["NotificationCount"],
        commentCount: json["CommentCount"] == null ? null : json["CommentCount"],
        canChangeOwner: json["CanChangeOwner"] == null ? null : json["CanChangeOwner"],
        noteSequenceOrder: json["NoteSequenceOrder"],
        noteDescription: json["NoteDescription"],
        noteSubject: json["NoteSubject"],
        includeSharedList: json["IncludeSharedList"] == null ? null : json["IncludeSharedList"],
        ...
        isVersioning: json["IsVersioning"] == null ? null : json["IsVersioning"],
        isLogRecord: json["IsLogRecord"] == null ? null : json["IsLogRecord"],
        chartItems: json["ChartItems"],
        resource: json["Resource"],
        ignorePermission: json["IgnorePermission"] == null ? null : json["IgnorePermission"],
        previousParentId: json["PreviousParentId"],
        uploadedContent: json["UploadedContent"],
        fileIds: json["FileIds"],
        logId: json["LogId"],
        referenceId: json["ReferenceId"],
        referenceType: json["ReferenceType"] == null ? null : json["ReferenceType"],
        ...
        enableIndexPage: json["EnableIndexPage"] == null ? null : json["EnableIndexPage"],
        enableNoteNumberManual: json["EnableNoteNumberManual"] == null ? null : json["EnableNoteNumberManual"],
        enableSaveAsDraft: json["EnableSaveAsDraft"] == null ? null : json["EnableSaveAsDraft"],
        ...
        enableBackButton: json["EnableBackButton"] == null ? null : json["EnableBackButton"],
        backButtonText: json["BackButtonText"],
        backButtonCss: json["BackButtonCss"],
        enableAttachment: json["EnableAttachment"] == null ? null : json["EnableAttachment"],
        enableComment: json["EnableComment"] == null ? null : json["EnableComment"],
        disableVersioning: json["DisableVersioning"] == null ? null : json["DisableVersioning"],
        ...
        createReturnType: json["CreateReturnType"] == null ? null : json["CreateReturnType"],
        editReturnType: json["EditReturnType"] == null ? null : json["EditReturnType"],
        ...
        enableCancelButton: json["EnableCancelButton"] == null ? null : json["EnableCancelButton"],
        isCancelReasonRequired: json["IsCancelReasonRequired"] == null ? null : json["IsCancelReasonRequired"],
        cancelButtonText: json["CancelButtonText"],
        cancelButtonCss: json["CancelButtonCss"],
        isUdfTemplate: json["IsUdfTemplate"] == null ? null : json["IsUdfTemplate"],
        isCompleteReasonRequired: json["IsCompleteReasonRequired"] == null ? null : json["IsCompleteReasonRequired"],
        ...
        hideDescription: json["HideDescription"] == null ? null : json["HideDescription"],
        hideStartDate: json["HideStartDate"] == null ? null : json["HideStartDate"],
        hideExpiryDate: json["HideExpiryDate"] == null ? null : json["HideExpiryDate"],
        hidePriority: json["HidePriority"] == null ? null : json["HidePriority"],
        hideOwner: json["HideOwner"] == null ? null : json["HideOwner"],
        isSubjectMandatory: json["IsSubjectMandatory"] == null ? null : json["IsSubjectMandatory"],
        isSubjectUnique: json["IsSubjectUnique"] == null ? null : json["IsSubjectUnique"],
        isDescriptionMandatory: json["IsDescriptionMandatory"] == null ? null : json["IsDescriptionMandatory"],
        hideToolbar: json["HideToolbar"] == null ? null : json["HideToolbar"],
        hideBanner: json["HideBanner"] == null ? null : json["HideBanner"],
        allowPastStartDate: json["AllowPastStartDate"] == null ? null : json["AllowPastStartDate"],
        enablePrintButton: json["EnablePrintButton"] == null ? null : json["EnablePrintButton"],
        printButtonText: json["PrintButtonText"],
        enableDataPermission: json["EnableDataPermission"] == null ? null : json["EnableDataPermission"],
        dataPermissionColumnId: json["DataPermissionColumnId"],
        numberGenerationType: json["NumberGenerationType"] == null ? null : json["NumberGenerationType"],
        isNumberNotMandatory: json["IsNumberNotMandatory"] == null ? null : json["IsNumberNotMandatory"],
        enableLegalEntityFilter: json["EnableLegalEntityFilter"] == null ? null : json["EnableLegalEntityFilter"],
        enablePermission: json["EnablePermission"] == null ? null : json["EnablePermission"],
        enableInlineComment: json["EnableInlineComment"] == null ? null : json["EnableInlineComment"],
        ...
        enableSequenceOrder: json["EnableSequenceOrder"] == null ? null : json["EnableSequenceOrder"],
        subjectMappingUdfId: json["SubjectMappingUdfId"],
        descriptionMappingUdfId: json["DescriptionMappingUdfId"],
        actionButtonPosition: json["ActionButtonPosition"] == null ? null : json["ActionButtonPosition"],
    ...
    Map<String, dynamic> toJson() => {
        ...
        "TemplateTypeName": templateTypeName == null ? null : templateTypeNameValues.reverse[templateTypeName],
        ...
        "NoteStatusBgCss": noteStatusBgCss == null ? null : noteStatusBgCssValues.reverse[noteStatusBgCss],
        "NoteStatusFontCss": noteStatusFontCss == null ? null : noteStatusFontCssValues.reverse[noteStatusFontCss],
        ...
        "IncludeReadonlyData": includeReadonlyData == null ? null : includeReadonlyData,
        "IsDraftButtonVisible": isDraftButtonVisible == null ? null : isDraftButtonVisible,
        "IsAcceptButtonVisible": isAcceptButtonVisible == null ? null : isAcceptButtonVisible,
        "IsSubmitButtonVisible": isSubmitButtonVisible == null ? null : isSubmitButtonVisible,
        "IsExpireButtonVisible": isExpireButtonVisible == null ? null : isExpireButtonVisible,
        "IsInEditMode": isInEditMode == null ? null : isInEditMode,
        "IsVersioningButtonVisible": isVersioningButtonVisible == null ? null : isVersioningButtonVisible,
        "IsReplyButtonVisible": isReplyButtonVisible == null ? null : isReplyButtonVisible,
        "IsBackButtonVisibile": isBackButtonVisibile == null ? null : isBackButtonVisibile,
        "IsPermittedUser": isPermittedUser == null ? null : isPermittedUser,
        "IsAddCommentEnabled": isAddCommentEnabled == null ? null : isAddCommentEnabled,
        "IsAddAttachmentEnabled": isAddAttachmentEnabled == null ? null : isAddAttachmentEnabled,
        "IsSharingEnabled": isSharingEnabled == null ? null : isSharingEnabled,
        "IsCompleteButtonVisible": isCompleteButtonVisible == null ? null : isCompleteButtonVisible,
        "IsCloseButtonVisible": isCloseButtonVisible == null ? null : isCloseButtonVisible,
        "SharedCount": sharedCount == null ? null : sharedCount,
        "AttachmentCount": attachmentCount == null ? null : attachmentCount,
        "NotificationCount": notificationCount == null ? null : notificationCount,
        ...
        "IncludeSharedList": includeSharedList == null ? null : includeSharedList,
        "CustomUrl": customUrl,
        "ReturnUrl": returnUrl,
        ...
        "EnableNoteNumberManual": enableNoteNumberManual == null ? null : enableNoteNumberManual,
        "EnableSaveAsDraft": enableSaveAsDraft == null ? null : enableSaveAsDraft,
        ...
        "DisableVersioning": disableVersioning == null ? null : disableVersioning,
        ...
        "Priority": priority,
        "EnableCancelButton": enableCancelButton == null ? null : enableCancelButton,
        "IsCancelReasonRequired": isCancelReasonRequired == null ? null : isCancelReasonRequired,
        "CancelButtonText": cancelButtonText,
        "CancelButtonCss": cancelButtonCss,
        "IsUdfTemplate": isUdfTemplate == null ? null : isUdfTemplate,
        "IsCompleteReasonRequired": isCompleteReasonRequired == null ? null : isCompleteReasonRequired,
        ...
        "IsSubjectMandatory": isSubjectMandatory == null ? null : isSubjectMandatory,
        "IsSubjectUnique": isSubjectUnique == null ? null : isSubjectUnique,
        "IsDescriptionMandatory": isDescriptionMandatory == null ? null : isDescriptionMandatory,
        "HideToolbar": hideToolbar == null ? null : hideToolbar,
        "HideBanner": hideBanner == null ? null : hideBanner,
        "AllowPastStartDate": allowPastStartDate == null ? null : allowPastStartDate,
        "EnablePrintButton": enablePrintButton == null ? null : enablePrintButton,
        "PrintButtonText": printButtonText,
        "EnableDataPermission": enableDataPermission == null ? null : enableDataPermission,
        "DataPermissionColumnId": dataPermissionColumnId,
        "NumberGenerationType": numberGenerationType == null ? null : numberGenerationType,
        "IsNumberNotMandatory": isNumberNotMandatory == null ? null : isNumberNotMandatory,
        "EnableLegalEntityFilter": enableLegalEntityFilter == null ? null : enableLegalEntityFilter,
        "EnablePermission": enablePermission == null ? null : enablePermission,
        "EnableInlineComment": enableInlineComment == null ? null : enableInlineComment,
        ...
        "EnableSequenceOrder": enableSequenceOrder == null ? null : enableSequenceOrder,
        "SubjectMappingUdfId": subjectMappingUdfId,
        "DescriptionMappingUdfId": descriptionMappingUdfId,
        "ActionButtonPosition": actionButtonPosition == null ? null : actionButtonPosition,
...
final templateTypeNameValues = EnumValues({
    "Basic": TemplateTypeName.BASIC,
    "General": TemplateTypeName.GENERAL
});
