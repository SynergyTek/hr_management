...
WorkBoardSectionModel workBoardSectionModelFromJson(String str) =>
    WorkBoardSectionModel.fromJson(json.decode(str));

String workBoardSectionModelToJson(WorkBoardSectionModel data) =>
...
class WorkBoardSectionModel {
  ...
  factory WorkBoardSectionModel.fromJson(Map<String, dynamic> json) =>
      WorkBoardSectionModel(
        ...
        sectionDigit:
            json["SectionDigit"] == null ? null : json["SectionDigit"],
        workBoardSectionId: json["WorkBoardSectionId"],
        ntsNoteId: json["NtsNoteId"],
        headerColorName:
            json["HeaderColorName"] == null ? null : json["HeaderColorName"],
        item: json["item"],
