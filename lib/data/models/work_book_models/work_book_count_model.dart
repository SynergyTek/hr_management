...
class WorkBookCountModel {
  ...
  int? tAssignedToMe;
  int? tAssignPlanned;
  int? tAssignPlannedOverdue;
  int? tAssignPending;
  int? tAssignPendingOverdue;
  ...
  int? nCreatedByMe;
  int? nCreatedByMeExpired;
  int? nCreatedByMeActive;
  int? nCreatedByMeDraft;
  int? nCreatedByMeAll;
  int? nCreatedByMeOverdue;
  int? nCreatedByMeCompleted;
  int? readCount;
  int? uUnReadCount;
  int? archivedCount;
  int? allCount;
  int? psCreatedByMe;
  int? psCreatedByMeExpired;
  int? psCreatedByMeActive;
  int? psCreatedByMeDraft;
  int? psCreatedByMeAll;
  int? psCreatedByMeOverdue;
  int? psCreatedByMeCompleted;
