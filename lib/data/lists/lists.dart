...
List<dynamic> navDrawerList = [
  ...
  ExapnsionTileModel(
      ...
      childList: [
        NavDrawerModel(
            ...
            pageName: 'Workspace'),
        NavDrawerModel(
            title: 'Documents', route: DMS_PARENT, pageName: 'CustomDashboard'),
        NavDrawerModel(
  ...
  ExapnsionTileModel(title: 'Self-service', isExpanded: true, childList: [
    NavDrawerModel(
        ...
        pageName: 'CustomDashboard'),
    NavDrawerModel(
        title: 'Misconduct', route: MISCONDUCT_SCREEN, pageName: 'Misconducts'),
  ]),
  ...
  ExapnsionTileModel(title: 'Payroll', isExpanded: true, childList: [
    ...
    NavDrawerModel(title: 'Payslip', route: PAYSLIP, pageName: 'PaySlip'),
  ]),
  ...
  ExapnsionTileModel(title: 'Attendance', isExpanded: true, childList: [
    ...
    NavDrawerModel(
        title: 'Access Logs', route: DISPLAY_ACCESS_LOG, pageName: 'AccessLog'),
  ]),
  ...
  ExapnsionTileModel(title: 'Help-desk', isExpanded: true, childList: [
    ...
    NavDrawerModel(
        ...
        pageName: 'CustomDashboard'),
    NavDrawerModel(title: 'My Tasks', route: TASK_HOME, pageName: 'MyTasks'),
  ]),
];
