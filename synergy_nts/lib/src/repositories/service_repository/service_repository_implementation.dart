...
class ServiceRepository extends AbstractServiceRepository {
  ...
  Future<TimePermissionResponse> getTimePermissionData({
    ...
    const String endpoint = APIEndpointConstants.GET_TIME_PERMISSION_DATA;
  ...
  Future<ReimbursementResponse> getTravelReimbursementData({
    ...
    const String endpoint = APIEndpointConstants.GET_TRAVEL_REIMBURSEMENT_DATA;
  ...
  Future<ReimbursementResponse> getMedicalReimbursementData({
    ...
    const String endpoint = APIEndpointConstants.GET_MEDICAL_REIMBURSEMENT_DATA;
  ...
  Future<ReimbursementResponse> getOtherReimbursementData({
    ...
    const String endpoint = APIEndpointConstants.GET_OTHER_REIMBURSEMENT_DATA;
